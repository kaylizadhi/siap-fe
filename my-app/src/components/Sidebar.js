    ...
    const fetchUserRole = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BASE_URL}accounts/get_sidebar_role/`,
          {
            headers: {
            ...
            {menuItems.map((item) => (
              <li
                ...
                className={
                  pathname ===
                  `${
                    item === "generator-dokumen"
                      ? "/generator-dokumen/proposal"
                      : `/${item}`
                  }`
              ...
              >
                ...
                >
                  <SidebarButtons
                    buttonText={menuLabels[item]}
                    svgIcon={menuIcons[item]}
                    route={`/${item}`}
                  />
                </Link>
              </li>
