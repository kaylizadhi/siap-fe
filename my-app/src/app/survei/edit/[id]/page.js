    ...
    return (
        <div>
            ...
            <div className={styles.containerSurvei}>
                ...
                <input className={styles.textFieldSurvei} type='text' name='namaklien' value={survei.nama_klien || ''} onChange={(event) => setSurvei({...survei, nama_klien: event.target.value})} />
                <b className={styles.textFieldTitleSurvei}>Daerah</b>
                <input className={styles.textFieldSurvei} type='text' name='ruanglingkup' value={survei.ruang_lingkup_survei || ''} onChange={(event) => setSurvei({...survei, ruang_lingkup_survei: event.target.value})} />
                <b className={styles.textFieldTitleSurvei}>Harga</b>
                <input className={styles.textFieldSurvei} type='text' name='hargasurvei' value={survei.harga_survei || ''} onChange={(event) => setSurvei({...survei, harga_survei: event.target.value})} />
                <b className={styles.textFieldTitleSurvei}>Jumlah Responden</b>
                <input className={styles.textFieldSurvei} type='text' name='jumlahresponden' value={survei.jumlah_responden || ''} onChange={(event) => setSurvei({...survei, jumlah_responden: event.target.value})} />
                <b className={styles.textFieldTitleSurvei}>Tanggal Mulai</b>
                <input min={new Date().toISOString().split("T")[0]} className={styles.container} type='date' name='tanggalmulai' value={survei.waktu_mulai_survei ? survei.waktu_mulai_survei.split("T")[0] : ""} onChange={(event) => setSurvei({...survei, waktu_mulai_survei: event.target.value})} />
                <b className={styles.textFieldTitleSurvei}>Tanggal Berakhir</b>
                <input min={new Date().toISOString().split("T")[0]} className={styles.container} type='date' name='tanggalberakhir' value={survei.waktu_berakhir_survei ? survei.waktu_berakhir_survei.split("T")[0] : ""} onChange={(event) => setSurvei({...survei, waktu_berakhir_survei: event.target.value})} />
