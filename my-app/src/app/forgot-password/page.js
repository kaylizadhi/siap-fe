    ...
    <div className={styles.forgotPasswordBody}>
      <div className={styles.forgotPasswordContainer}>
        ...
        {step === 1 && (
          <div>
            <h3>Username</h3>
            <input type="text" className={styles.Input} placeholder="Masukkan username" value={username} onChange={(e) => setUsername(e.target.value)} required />
            <button onClick={handleGetSecurityQuestion} className={styles.Button}>
        ...
        {step === 2 && (
          <div>
            ...
            <input type="text" className={styles.Input} placeholder="Masukkan jawaban" value={securityAnswer} onChange={(e) => setSecurityAnswer(e.target.value)} required />
            <input type="password" className={styles.Input} placeholder="Masukkan password baru" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required />
            <button onClick={handleVerifyAnswer} className={styles.Button}>
              Reset Password
            </button>
          </div>
        )}
