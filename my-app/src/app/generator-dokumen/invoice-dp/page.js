...
const InvoiceDP = () => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/dokumen_pendukung/generate_invoice_dp/', {
        method: 'POST',
        headers: {
      ...
      a.href = url;
      a.download = `invoiceDP_${surveyName}.xlsx`; // Set the downloaded file name
