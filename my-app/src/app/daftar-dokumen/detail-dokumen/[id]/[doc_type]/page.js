...
export default function DokumenDetail({ params }) {
  ...
  const handleExport = async () => {
    ...
    const config = {
      invoiceDP: {
        url: "http://localhost:8000/dokumen_pendukung/export_existing_invoice_dp/",
      ...
      invoiceFinal: {
        url: "http://localhost:8000/dokumen_pendukung/export_existing_invoice_final/",
      ...
      kwitansiDP: {
        url: "http://localhost:8000/dokumen_pendukung/export_existing_kwitansi_dp/",
      ...
      kwitansiFinal: {
        url: "http://localhost:8000/dokumen_pendukung/export_existing_kwitansi_final/",
